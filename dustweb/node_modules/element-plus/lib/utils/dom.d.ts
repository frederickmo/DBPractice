...
export declare const isScroll: (el: HTMLElement, isVertical?: any) => RegExpMatchArray;
export declare const getScrollContainer: (el: HTMLElement, isVertical?: any) => Window | HTMLElement;
